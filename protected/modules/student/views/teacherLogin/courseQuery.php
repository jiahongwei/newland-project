			...
			<div style="height:600px">
				<table cellspacing="0px" class="content_list">
					...
					<tr class="tb_header">
						...
						<td><a href="<?php echo  $this->createUrl('courseNumberQuery',array('courseId'=>$value['courseId'],'courseName' => $value['courseName']))?>">详细信息</a></td>
						<!-- <td><a href="<?php echo  $this->createUrl('update',array('courseId'=>$value['courseId']))?>"><img align="absmiddle" src="/cms_new/static/admin/images/update.png"></a></td> -->
						<!-- <td><a href="<?php echo  $this->createUrl('delete',array('courseId'=>$value['courseId']))?>" onclick="return confirm('确定要删除这门课程吗?')"><img align="absmiddle" src="/cms_new/static/admin/images/delete.png"></a></td> -->
					</tr>
					<?php }}?>
				</table>
			</div>
