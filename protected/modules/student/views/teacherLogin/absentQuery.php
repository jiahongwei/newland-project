			...
			<div style="height:600px">
				<table cellspacing="0px" class="content_list">
					...
					<tr class="tb_header">
						...
						<!-- <td><a href="<?php echo  $this->createUrl('delete',array('stuAbsentId'=>$value['stuAbsentId']))?>" onclick="return confirm('确定要删除这条记录吗?')"><img align="absmiddle" src="/cms_new/static/admin/images/delete.png"></a></td> -->
					</tr>
					<?php }}?>
				</table>
			</div>
