      ...
      <div style="height:50px;"></div>
        ...
        <div>
          ...
          <table border="0px" cellspacing="0px" class="addForm">
            <tr>
              <td>RFID编号:</td>
              <td id="text"><?php echo $data['RFID'];?></td>
            </tr>
            <tr>
              <td>是否允许带出:</td>
              <td>  
            ...
            <tr>
              <td>价格(元):</td>
              <td><input type="text" name="Price" id="Price" pattern="^(?:[1-9]\d*|0)(?:\.\d+)?$" oninput="setCustomValidity('')" oninvalid="setCustomValidity('价格格式不正确(数字)')" value="<?php echo $data['Price'];?>" required></td>
            </tr>
            <tr>
              <td>借出人电话:</td>
              <td><input type="text" name="brwPhone" id="brwPhone" pattern="^1(3|5|8|7)\d{9}$" oninvalid="setCustomValidity('手机号码格式不正确')" value="<?php echo $data['brwPhone'];?>"></td>
            </tr>
            <tr>
              <td>存储仓库:</td>
        ...
        <div>
          ...
          <a href="<?php echo  $this->createUrl('showAsset',array ('assetName' => $data['assetName'] , 'specification' => $data['specification'] , 'type' => 'static'))?>">返回</a>
        </div>
        </form>
      </center>
  </div>
