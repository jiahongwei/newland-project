...
<center>
  ...
  <div class="log_body">
    <div class="log_in">
      ...
      <dl>
        <dd><input type="text" name="adminId" value="用户名" class="input-password" onblur="if(this.value==''){this.value='用户名';}" onclick="if(this.value='用户名'){this.value='';}"><?php echo $form->error($model,'adminId'); ?> </dd>
