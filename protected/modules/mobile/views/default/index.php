...
<div class="slider">
  <ul class="clearfix"> 
    ...
    <li><a href="http://localhost/cms_new/index.php#bg2" ondblclick="javascript:location.href='http://localhost/cms_new/index.php?r=energy/public/login'">能源管理</a></li>
...
<a href="http://localhost/cms_new/index.php?r=energy/public/login"><img src="<?php echo $this->_baseUrl?>/themes/default/images/bg2.jpg" class="bg slideBottom" id="bg2"></a>
